object Form1: TForm1
  Left = 0
  Top = 0
  Caption = 'Parser DB Tecnico - v1.2c'
  ClientHeight = 729
  ClientWidth = 938
  Color = clBtnFace
  ...
  object gammaConnection1: TFDConnection
  ...
  object viewProdotti: TFDQuery
    Connection = gammaConnection1
    SQL.Strings = (
      'SELECT * FROM V_Articoli_OPTOI')
    Left = 715
    Top = 141
  end
end
