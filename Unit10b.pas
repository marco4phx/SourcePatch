...
var
  ...
  ListItem: TListItem;
begin
  xls := TXlsFile.Create( aPathAndFileName );    // \\Netserver\06.Qualità\SGQ2_attività\01_Mansionari_IOP_MOD\02.R&D\02.IOP\01.Lista IOP.R&D.xlsx
  try
    ...
    mmLog.Lines.Add('Aperto file Lista IOP: '+ edtXlsCodici.text);
    mmLog.Lines.Add('Trovati '+ rowCount.ToString +' documenti IOP.');
