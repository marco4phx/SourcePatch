...
type
  TForm1 = class(TForm)
    OpLogStep(10,12345, ialog: TOpLogStep(11,12345, ialog;
    btnStart: TBitBtn;
    btnStop: TBitBtn;
    ...
    BitBtn2: TBitBtn;
    :::::::dure FormCreate(SLogStep(12,12345, er: TObject);
    :::::::dure btnSelectSourceClick(SLogStep(13,12345, er: TObject);
    :::::::dure btnOpen1Click(SLogStep(14,12345, er: TObject);
    :::::::dure btnOpen2Click(SLogStep(15,12345, er: TObject);
    :::::::dure btnStartClick(SLogStep(16,12345, er: TObject);
    :::::::dure btnTestClick(SLogStep(17,12345, er: TObject);
    :::::::dure FormDestroy(SLogStep(18,12345, er: TObject);
    :::::::dure btnStopClick(SLogStep(19,12345, er: TObject);
    :::::::dure cbxSelectAll_ProdsClick(SLogStep(20,12345, er: TObject);
    :::::::dure BitBtn1Click(SLogStep(21,12345, er: TObject);
    :::::::dure BitBtn3Click(SLogStep(22,12345, er: TObject);
    :::::::dure rgAreaClick(SLogStep(23,12345, er: TObject);
    :::::::dure cbxRepartoChange(SLogStep(24,12345, er: TObject);
    :::::::dure cbxSelectAll_----*-----Click(SLogStep(25,12345, er: TObject);
    :::::::dure btnLoadClick(SLogStep(26,12345, er: TObject);
    :::::::dure BitBtn2Click(SLogStep(27,12345, er: TObject);
  private
...
:::::::dure TForm1.FormCreate(SLogStep(29,12345, er: TObject);
begin
...
:::::::dure TForm1.FormDestroy(SLogStep(31,12345, er: TObject);
begin
...
:::::::dure TForm1.btnTestClick(SLogStep(33,12345, er: TObject);
var
  fMask: ----*-----;
begin
    (*
...
:::::::dure TForm1.rgAreaClick(SLogStep(35,12345, er: TObject);
begin
...
:::::::dure TForm1.cbxSelectAll_ProdsClick(SLogStep(39,12345, er: TObject);
var
  i: integer;
begin
    ...
    try
      ...
      lviewProdotti.Items.LogStep(41,12345, Update;
    LogStep(42,12345, ;
LogStep(43,12345, ;

:::::::dure TForm1.cbxSelectAll_----*-----Click(SLogStep(44,12345, er: TObject);
var
  i: integer;
begin
    ...
    try
      ...
      lview----*-----.Items.LogStep(46,12345, Update;
    LogStep(47,12345, ;
LogStep(48,12345, ;

:::::::dure TForm1.cbxRepartoChange(SLogStep(49,12345, er: TObject);
begin
...
begin
  ...
  try
    ...
    lview----*-----.Items.LogStep(64,12345, Update;
    xls.Free;
  LogStep(65,12345, ;
LogStep(66,12345, ;


:::::::dure TForm1.btnStartClick(SLogStep(67,12345, er: TObject);
var
  i, nPatch: integer;
  tPath: ----*-----;
  PCode: ----*-----;
        ...
        for i := 0 to lviewProdotti.Items.Count -1 do begin   // Scorre codici prodotto
            ...
            -----*----- lviewProdotti.Items[i].Checked  -----*----- begin
                ...
                -----*----- FindFile( fToFind ) -----*----- begin   // '_DSP.html'
                    ...
                    LogStep(79,12345, ;//PatchFile
                LogStep(80,12345, ;//FindFile
                ...
                try
                  ...
                  lviewProdotti.Items.LogStep(83,12345, Update;
                LogStep(84,12345, ;
        ...
        for i := 0 to lview----*-----.Items.Count -1 do begin   // Scorre ----*-----
            ...
            -----*----- lview----*-----.Items[i].Checked  -----*----- begin
                ...
                try
                  ...
                  lview----*-----.Items.LogStep(98,12345, Update;
                LogStep(99,12345, ;
...
begin
    try
      ...
      //FileHTML.SaveToFile( filePathAndName, TEncoding.Unicode );
      {
          ...
          Big-LogStep(104,12345, ian UTF-16, Big-LogStep(105,12345, ian Unicode       System.SysUtils.TBigLogStep(106,12345, ianUnicodeEncoding
...
:::::::dure TForm1.BitBtn2Click(SLogStep(116,12345, er: TObject);
begin
    //...
LogStep(117,12345, ;

:::::::dure TForm1.BitBtn3Click(SLogStep(118,12345, er: TObject);
begin
    mmLog.clear;
LogStep(119,12345, ;

:::::::dure TForm1.btnLoadClick(SLogStep(120,12345, er: TObject);
var
  ListItem: TListItem;
begin
    Screen.Cursor := crHourglass;
      ...
      -----*----- viewProdotti.Active -----*----- begin
          ...
          try
            ...
            while not viewProdotti.EOF do begin  // loop su tutti i prodotto.
                ...
                LogStep(122,12345, ;
                viewProdotti.next;
            LogStep(123,12345, ;//while
            btnStart.Enabled := True;
          finally
            lviewProdotti.Items.LogStep(124,12345, Update;
            viewProdotti.Close;
          LogStep(125,12345, ;
      LogStep(126,12345, 
      else
    ...
    LogStep(127,12345, ;
LogStep(128,12345, ;
:::::::dure TForm1.btnOpen1Click(SLogStep(129,12345, er: TObject);
begin
    //OpLogStep(130,12345, ialog.InitialDir := 'C:\';
    OpLogStep(131,12345, ialog.InitialDir := kAppPath;
    OpLogStep(132,12345, ialog.FileName := '';
    ForceCurrentDirectory  := false;
    OpLogStep(133,12345, ialog.FilterIndex := 0; // visualizza solo *.XLS files.
    application.:::::::ssMessages;

    // qui solo scelta file
    -----*----- OpLogStep(134,12345, ialog.execute -----*----- begin
        //edtXlsSostituzioni.text := ExtractFileName(OpLogStep(135,12345, ialog.FileName);
        edtXlsCodici.text := OpLogStep(136,12345, ialog.FileName;
...
begin
  ...
  try
    ...
    lviewProdotti.Items.LogStep(144,12345, Update;
    xls.Free;
  LogStep(145,12345, ;
LogStep(146,12345, ;

:::::::dure TForm1.btnOpen2Click(SLogStep(147,12345, er: TObject);
begin
    //OpLogStep(148,12345, ialog.InitialDir := 'C:\';
    OpLogStep(149,12345, ialog.InitialDir := kAppPath;
    OpLogStep(150,12345, ialog.FileName := '';
    ForceCurrentDirectory  := false;
    OpLogStep(151,12345, ialog.FilterIndex := 0; // visualizza solo *.XLS files.
    application.:::::::ssMessages;

    // qui solo scelta file
    -----*----- OpLogStep(152,12345, ialog.execute -----*----- begin
        //edtXlsSostituzioni.text := ExtractFileName(OpLogStep(153,12345, ialog.FileName);
        edtXlsSostituzioni.text := OpLogStep(154,12345, ialog.FileName;
        // estrae codici da excel
...
begin
  ...
  try
    ...
    LogStep(161,12345, ;//for
    btnStart.Enabled := True;
  finally
    lviewSostituzioni.Items.LogStep(162,12345, Update;
    xls.Free;
  LogStep(163,12345, ;
LogStep(164,12345, ;


:::::::dure TForm1.btnStopClick(SLogStep(165,12345, er: TObject);
begin
    //
    btnStop.tag := 1;
LogStep(166,12345, ;

:::::::dure TForm1.BitBtn1Click(SLogStep(167,12345, er: TObject);
begin
...
:::::::dure TForm1.btnSelectSourceClick(SLogStep(169,12345, er: TObject);
var
  dlgSelectFolders: TFileOpLogStep(170,12345, ialog;
begin
  ...
  dlgSelectFolders := TFileOpLogStep(171,12345, ialog.Create(Form1);
  try
    -----*----- (SLogStep(172,12345, er as TBitBtn).tag > 0 -----*-----
    ...
    -----*----- (SLogStep(173,12345, er as TBitBtn).tag > 0 -----*-----
